...
/**
 * @title ERC20, implementation of the {IERC20} interface.
 */
...
/**
 * @title LuckyCookies Contract
 */
contract LuckyCookies is Context, ERC20 {
    using SafeMath for uint256;

    address private _game;
    uint8 constant private DECIMALS = 0;
    string constant private SYMBOL = 'COOKIES';
    string constant private NAME = 'Lucky Cookies';


    constructor () public {
        _game = address(0x1234567B172f040f45D7e924C0a7d088016191A6);
    }
    ...
    function game() public view returns (address) {
        return _game;
    }

    modifier onlyGame() {
        require(_game == _msgSender(), "LuckyCookies: caller is not the game contract");
        _;
    }

    function mint(address account) public onlyGame returns (uint256) {
        // uint256 amount = ...;
